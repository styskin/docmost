...
describe("Regex Utils", () => {
  describe("createRegex", () => {
    ...
    it("should create a RegExp object from a complex pattern", () => {
      const pattern =
        "(An AI agent is a software system that uses artificial intelligence to interact with its environment, gather information, and take actions to achieve specific goals\\.)";
      const regex = createRegex(pattern);
      expect(regex).toBeInstanceOf(RegExp);
      expect(regex.source).toBe(pattern);
    });
  ...
  describe("testRegex", () => {
    ...
    it("should match the AI agent definition", () => {
      const regex =
        /(An AI agent is a software system that uses artificial intelligence to interact with its environment, gather information, and take actions to achieve specific goals\.)/g;
      const docText =
  ...
  describe("matchAllRegex", () => {
    ...
    it("should match the AI agent definition with global flag", () => {
      const patternText =
        "(AI agents are used in various fields, including customer service, software development, security, and automation.)";
